...
- Kleine Änderungen wie reine `AGENTS.md`-Updates dürfen auf der aktuellen Branch oder direkt auf `dev` passieren, wenn dadurch kein Commit-Stand vermischt wird und keine Konflikte entstehen.
